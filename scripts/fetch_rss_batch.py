...
from news_curator.static_store import upsert_raw_articles
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Fetch RSS articles into data/news_items.json without LLM calls.")
